 ...
 * `configPage` is set). Plugin pages reach grid state through
 * `IrisGridControlContext` (see `controllable/IrisGridControlContext.tsx`)
 * and only receive read-only handles + the back-navigation callback
 * through these props.
 */
